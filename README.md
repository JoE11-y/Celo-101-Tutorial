...
1. [GraphQL Schema](https://graphql.org/learn/schema/): This defines the data types/entities you would like to save and query for. You can also define configurations like relationships and full-text search capabilities in your schema.
...
- Basic knowledge of how to use the [Remix IDE](https://remix.ethereum.org/)
...
To get started, go to [The Graph's Hosted Service](https://thegraph.com/hosted-service) and log in using your GitHub account, and visit the **My Dashboard** tab.
